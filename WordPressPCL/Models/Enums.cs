...
namespace WordPressPCL.Models
{
    ...
    public enum TermTaxonomy
    {
        ...
        /// itemlocation
        /// </summary>
        [EnumMember(Value = "itemlocation")]
        itemlocation,

        /// <summary>
        /// honeymoonexperience
        /// </summary>
        [EnumMember(Value = "honeymoonexperience")]
        honeymoonexperience,

        /// <summary>
        /// honeymoonexperience
        /// </summary>
        [EnumMember(Value = "typeofservice")]
        typeofservice,
        ...
        /// itemsetting
        /// </summary>
        [EnumMember(Value = "itemsetting")]
        itemsetting,

        /// <summary>
        /// itemcateringservices
        /// </summary>
        [EnumMember(Value = "itemcateringservices")]
        itemcateringservices,

        /// <summary>
        /// itemtypeoffurniture
        /// </summary>
        [EnumMember(Value = "itemtypeoffurniture")]
        itemtypeoffurniture,

        /// <summary>
        /// itemclientele
        /// </summary>
        [EnumMember(Value = "itemclientele")]
        itemclientele,

        /// <summary>
        /// itemclothing
        /// </summary>
        [EnumMember(Value = "itemclothing")]
        itemclothing,

        /// <summary>
        /// itembeautyservices
        /// </summary>
        [EnumMember(Value = "itembeautyservices")]
        itembeautyservices,

        /// <summary>
        /// itemtypeofmusicians
        /// </summary>
        [EnumMember(Value = "itemtypeofmusicians")]
        itemtypeofmusicians,

        /// <summary>
        /// itemcity
        /// </summary>
        [EnumMember(Value = "itemcity")]
        itemcity,

        /// <summary>
        /// item_amenities
        /// </summary>
        [EnumMember(Value = "item_amenities")]
        item_amenities
