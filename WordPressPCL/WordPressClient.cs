...
namespace WordPressPCL
{
    ...
    public class WordPressClient
    {
        ...
        /// <summary>
        /// Items client interaction object
        /// </summary>
        public Items Items;
        ...
        /// <summary>
        /// ItemCategories client interaction object
        /// </summary>
        public ItemCategories ItemCategories;
        /// <summary>
        /// ItemTypes client interaction object
        /// </summary>
        public ItemTypes ItemTypes;
        /// <summary>
        /// ItemCities client interaction object
        /// </summary>
        public ItemCities ItemCities;
        /// <summary>
        /// ItemSettings client interaction object
        /// </summary>
        public ItemSettings ItemSettings;
        /// <summary>
        /// ItemCateringServices client interaction object
        /// </summary>
        public ItemCateringServices ItemCateringServices;
        /// <summary>
        /// ItemTypeOfFurnitures client interaction object
        /// </summary>
        public ItemTypeOfFurnitures ItemTypeOfFurnitures;
        /// <summary>
        /// ItemClienteles client interaction object
        /// </summary>
        public ItemClienteles ItemClienteles;
        /// <summary>
        /// ItemClothings client interaction object
        /// </summary>
        public ItemClothings ItemClothings;
        /// <summary>
        /// ItemBeautyServices client interaction object
        /// </summary>
        public ItemBeautyServices ItemBeautyServices;
        /// <summary>
        /// ItemTypeOfMusicians client interaction object
        /// </summary>
        public ItemTypeOfMusicians ItemTypeOfMusicians;
        /// <summary>
        /// HoneymoonExperiences client interaction object
        /// </summary>
        public HoneymoonExperiences HoneymoonExperiences;
        /// <summary>
        /// TypeOfServices client interaction object
        /// </summary>
        public TypeOfServices TypeOfServices;
        /// <summary>
        /// ItemLocations client interaction object
        /// </summary>
        public ItemLocations ItemLocations;
        /// <summary>
        /// Capacities client interaction object
        /// </summary>
        ...
        public WordPressClient(string uri, string defaultPath = "wp/v2/")
        {
            ...
            Items = new Items(ref _httpHelper, _defaultPath);
            ...
            ItemCategories = new ItemCategories(ref _httpHelper, _defaultPath);

            ItemTypes = new ItemTypes(ref _httpHelper, _defaultPath);
            ItemCities = new ItemCities(ref _httpHelper, _defaultPath);
            ItemSettings = new ItemSettings(ref _httpHelper, _defaultPath);
            Capacities = new Capacities(ref _httpHelper, _defaultPath);
            ItemCateringServices = new ItemCateringServices(ref _httpHelper, _defaultPath);
            ItemTypeOfFurnitures = new ItemTypeOfFurnitures(ref _httpHelper, _defaultPath);
            ItemClienteles = new ItemClienteles(ref _httpHelper, _defaultPath);
            ItemClothings = new ItemClothings(ref _httpHelper, _defaultPath);
            ItemBeautyServices = new ItemBeautyServices(ref _httpHelper, _defaultPath);
            ItemTypeOfMusicians = new ItemTypeOfMusicians(ref _httpHelper, _defaultPath);
            HoneymoonExperiences = new HoneymoonExperiences(ref _httpHelper, _defaultPath);
            TypeOfServices = new TypeOfServices(ref _httpHelper, _defaultPath);
            ItemLocations = new ItemLocations(ref _httpHelper, _defaultPath);
