...
namespace ImportFromWordPress
{
    public class consoleDbContext : IdentityDbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=MAIZONPUBSERVER\SQLEXPRESS;Database=PlanMy;Trusted_Connection=True;MultipleActiveResultSets=true;user id=sa;password=M@x1mumS3c;");
        }
