...
add_action('add_tg_meta_boxes', 'tg_add_product_gallery_metabox');
add_action('save_post', 'tg_save_product_metaboxes');
function tg_post_gallery_request() {
...
add_action( 'wp_ajax_tg_post_gallery_request', 'tg_post_gallery_request' );
add_action( 'admin_head-post.php', 'tg_images_call_js' );
add_action( 'admin_head-post-new.php', 'tg_images_call_js' );
function tg_images_call_js(){ ?>
	...
	$( function() {
		...
		var ajaxurl = '<?php echo admin_url('admin-ajax.php'); ?>';
			$.ajax({
					url: ajaxurl,
					data: {
					'action':'tg_post_gallery_request',
					'call_data' : call
				},
