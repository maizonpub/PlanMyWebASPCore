...
namespace PlanMyWeb.Controllers.Admin
{
    ...
    public class OffersCategoriesController : Controller
    {
        ...
        [Route("Admin/OffersCategories/Create")]
        ...
        [Route("Admin/OffersCategories/Edit/{id?}")]
        ...
        [Route("Admin/OffersCategories/Delete/{id?}")]
