...
namespace PlanMyWeb.Controllers.Admin
{
    public class ManageOffersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,OffersType,Image,Title,UserId,Description,Validity,StartDate,EndDate,Price")] Offers offers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,OffersType,Image,Title,UserId,Description,Validity,StartDate,EndDate,Price")] Offers offers)
        {
            if (id != offers.Id)
            {
                return NotFound();
