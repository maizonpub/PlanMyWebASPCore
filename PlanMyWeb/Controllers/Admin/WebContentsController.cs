...
namespace PlanMyWeb.Controllers.Admin
{
    public class WebContentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TipsTitle,FeaturedVendorsTitle,BlogId,ContactAddress,ContactEmail,ContactPhone,AdminEmail,AdminEmailPassword")] WebContent webContent)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TipsTitle,FeaturedVendorsTitle,BlogId,ContactAddress,ContactEmail,ContactPhone,AdminEmail,AdminEmailPassword")] WebContent webContent)
        {
            if (id != webContent.Id)
            {
                return NotFound();
