...
namespace WooCommerceNET.WooCommerce.v2
{
    ...
    public class PaymentGateway
    {
        ...
        /// </summary>
        [DataMember(EmitDefaultValue = false)]
        public PaymentGatewaySetting settings { get; set; }
    ...
    {
        [DataMember(EmitDefaultValue = false)]
        public settings title { get; set; }
        [DataMember(EmitDefaultValue = false)]
        public settings transaction_type { get; set; }
        [DataMember(EmitDefaultValue = false)]
        public settings enable_csc { get; set; }
        [DataMember(EmitDefaultValue = false)]
        public settings card_types { get; set; }
        [DataMember(EmitDefaultValue = false)]
        public settings environment { get; set; }
        [DataMember(EmitDefaultValue = false)]
        public settings merchantid { get; set; }
        [DataMember(EmitDefaultValue = false)]
        public settings transactionkeytest { get; set; }
        [DataMember(EmitDefaultValue = false)]
        public settings transactionkeylive { get; set; }
        [DataMember(EmitDefaultValue = false)]
        public settings debug_mode { get; set; }
    }
    [DataContract]
